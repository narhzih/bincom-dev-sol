...
@section('content')
    <div class="container mt-5">
        <div class="bg-light p-5 rounded-lg m-3">
            <h1 class="display-4">Hi there Guru!</h1>
            <p class="lead">Welcome to <b>BincomPoll</b> platform. You can use the navigation links above to find your way around</p>
            <hr class="my-4">
            <p>
            ...
            <a class="btn btn-outline-dark btn-lg" href="{{route('pu')}}" role="button">Available polling units &rarr;</a>
        </div>
    </div>
@endsection
