...
class LgaResultsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        // Seed for announced_lga_results
        $announcedLgaResults = [
        ...
        foreach ($announcedLgaResults as $announcedLgaResult) {
            DB::table('announced_lga_results')->insert([
                "id" => $announcedLgaResult[0],
                "lga_name" => $announcedLgaResult[1],
                "party_abbreviation" => $announcedLgaResult[2],
                "party_score" => $announcedLgaResult[3],
                "entered_by_user" => $announcedLgaResult[4],
                "date_entered" => ($announcedLgaResult[5] === "0000-00-00 00:00:00")? null :$announcedLgaResult[5],
                "user_ip_address" => $announcedLgaResult[6]
            ]);
        }
    }
}
